                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{route('admin.about.update')}}"  method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                               @csrf
                                <!-- Hakkimizda Başlık -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="name" value="{{$abouts->name}}" >
                                    </div>
                                </div>
                                <!-- Hakkimizda İçerik -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="ckeditor" name="about_content">{{$abouts->about_content}}</textarea>
                                    </div>
                                </div>
                                <!-- Hakkimizda Video -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="about_video" value="{{$abouts->about_video}}" >
                                    </div>
                                </div>
                                <!-- Hakkimizda Vizyon -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="about_vizyon" value="{{$abouts->about_vizyon}}" >
                                    </div>
                                </div>
                                <!-- Hakkimizda Misyon -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="editor2" id="editor2" name="about_misyon">{{$abouts->about_misyon}}</textarea>
                                    </div>
                                </div>
                                <script>
                                ...
                                <div  align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="aboutSave"class="btn btn-primary">Kaydet</button>
                                </div>
